...
//   // Get user's first name initial (capital letter)
...
//             className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-700 dark:text-white rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition"
//           >
